...
namespace BL
{
    public partial class BL : IBL.IBL
    {
        public partial class BLObject
        {
            ...
            /// <returns></returns>
            double DistanceBetween(IBL.BO.Location first, IBL.BO.Location second)
            {
            ...
            /// <returns></returns>
            IDAL.DO.Station ClosestStation(IBL.BO.Location location )
            {
            ...
            /// <returns></returns>
            double ChargeForDistance(IDAL.DO.WeightCategory weight, double distance)
            {
